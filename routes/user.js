...
// http://localhost:3000/users/add_user
// Add user
// public
router.post('/add_user',(req,res)=>{
    const {name,email,phone}=req.body
    const newUser= new userList({name,email,phone})
    newUser.save()
...
// http://localhost:3000/users/edit_user/:_id
// edit user by id
// public
...
// http://localhost:3000/users/delete_user/:_id
// delete user by id
// public
